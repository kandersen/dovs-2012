(************************************************************************)
(** AST type produced by the disambiguation phase                       *)
(************************************************************************)
...
and lvalue_desc =
  ...
  | Array of exp * exp
(*| AmbiguousName of name -- DISAMBIGUATED *)
  | Local of identifier                   (* new *)
  | StaticField of namedtype * identifier (* new *)
...
(*| AmbiguousInvoke of name * identifier * exp list -- DISAMBIGUATED *)
