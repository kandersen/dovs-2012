(************************************************************************)
(** AST type produced by the resource phase                             *)
(************************************************************************)
...
and lvalue_desc =
  | NonstaticField of exp * identifier * Types.canonical_name
  | Array of exp * exp
  | Local of identifier * int (* NEW *)
  | StaticField of namedtype * identifier * Types.canonical_name
...
(*  | CharConst of char *)
  ...
  | Cast of typeexp * exp
  | Instanceof of exp * typeexp  (* INVARIANT: typeexp namedtype or array *)
  | ArrayLength of exp
  | ArrayClone of exp
...
and stm_desc =
  ...
  | VoidReturn
  | ValueReturn of exp
  | LocalDecl of typeexp * identifier * exp option * int (*NEW*)
  | Throw of exp
...
type type_decl =
    { type_decl_pos       : Lexing.position;
      ...
      type_decl_signature : string (*NEW*) }
