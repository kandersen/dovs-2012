 ...
 */
public class Je_6_ThrowOk_Field {
	public Je_6_ThrowOk_Field() {}
	
	public int method() throws java.io.IOException {
		return 123;
	}
	
	public int field = method(); // error: method() throws java.io.IOException
	
	public static int test() {
		Je_6_ThrowOk_Field o = new Je_6_ThrowOk_Field();
		return o.field;
	}
}