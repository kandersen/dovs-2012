 ...
 */
public class Je_6_ThrowOk_Field_Static {
	public Je_6_ThrowOk_Field_Static() {}
	
	public static int method() throws java.io.IOException {
		return 123;
	}
	
	public int field = Je_6_ThrowOk_Field_Static.method(); // error: method() throws java.io.IOException
	
	public static int test() {
		Je_6_ThrowOk_Field_Static o = new Je_6_ThrowOk_Field_Static();
		return o.field;
	}
}