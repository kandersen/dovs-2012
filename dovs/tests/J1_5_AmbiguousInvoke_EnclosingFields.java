...
public class J1_5_AmbiguousInvoke_EnclosingFields {
	public J1_5_AmbiguousInvoke_EnclosingFields b;
	public J1_5_AmbiguousInvoke_EnclosingFields c;
	public J1_5_AmbiguousInvoke_EnclosingFields d;
	public J1_5_AmbiguousInvoke_EnclosingFields e;
	public String string;
	
	public J1_5_AmbiguousInvoke_EnclosingFields(String prefix, int level) {
		string = prefix; 
		if (level >= 0) {
			b = new J1_5_AmbiguousInvoke_EnclosingFields(prefix + ".b", level-1);
			c = new J1_5_AmbiguousInvoke_EnclosingFields(prefix + ".c", level-1);
			d = new J1_5_AmbiguousInvoke_EnclosingFields(prefix + ".d", level-1);
			e = new J1_5_AmbiguousInvoke_EnclosingFields(prefix + ".e", level-1);
		}
	}
	...
	public static int test() {
		int result = 0;
		J1_5_AmbiguousInvoke_EnclosingFields a = new J1_5_AmbiguousInvoke_EnclosingFields("a",5);
