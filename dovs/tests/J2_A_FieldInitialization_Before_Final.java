...
public class J2_A_FieldInitialization_Before_Final {
	public int b = this.a; // b = 22
	public final int a = 22; // a = 22 <- canonicalized javac behaviour (not JLS): constant nonstatic final fields are initialized first

	public J2_A_FieldInitialization_Before_Final() {}
	
	public static int test() {
		J2_A_FieldInitialization_Before_Final j = new J2_A_FieldInitialization_Before_Final();
		return j.a + j.b + 79;
	}
}